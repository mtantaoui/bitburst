...
impl SimdVec<i32> for I32x4 {
    ...
    fn splat(value: i32) -> Self {
        Self {
            elements: unsafe { _mm_set1_epi32(value) },
            size: LANE_COUNT,
        }
    }
    ...
    unsafe fn load_partial(ptr: *const i32, size: usize) -> Self {
        ...
        let elements = match size {
            1 => unsafe { _mm_set_epi32(0, 0, 0, *ptr.add(0)) },
            2 => unsafe { _mm_set_epi32(0, 0, *ptr.add(1), *ptr.add(0)) },
            3 => unsafe { _mm_set_epi32(0, *ptr.add(2), *ptr.add(1), *ptr.add(0)) },
