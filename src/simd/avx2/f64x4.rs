...
impl SimdVec<f64> for F64x4 {
    ...
    unsafe fn load_partial(ptr: *const f64, size: usize) -> Self {
        ...
        let elements = match size {
            1 => unsafe { _mm256_set_pd(0.0, 0.0, 0.0, *ptr.add(0)) },
            2 => unsafe { _mm256_set_pd(0.0, 0.0, *ptr.add(1), *ptr.add(0)) },
            3 => unsafe { _mm256_set_pd(0.0, *ptr.add(2), *ptr.add(1), *ptr.add(0)) },
            _ => unreachable!(),
        };
    ...
    fn store(&self) -> Vec<f64> {
        ...
        unsafe {
            _mm256_storeu_pd(vec.as_mut_ptr(), self.elements);
        }
    ...
    fn eq_elements(&self, rhs: Self) -> Self {
        ...
        let elements = unsafe { _mm256_cmp_pd(self.elements, rhs.elements, _CMP_EQ_OQ) }; // Result as float mask
    ...
    fn lt_elements(&self, rhs: Self) -> Self {
        ...
        // Compare a<b elementwise
        let elements = unsafe { _mm256_cmp_pd(self.elements, rhs.elements, _CMP_LT_OQ) }; // Result as float mask
    ...
    fn le_elements(&self, rhs: Self) -> Self {
        ...
        // Compare a<=b elementwise
        let elements = unsafe { _mm256_cmp_pd(self.elements, rhs.elements, _CMP_LE_OQ) }; // Result as float mask
    ...
    fn gt_elements(&self, rhs: Self) -> Self {
        ...
        // Compare a>b elementwise
        let elements = unsafe { _mm256_cmp_pd(self.elements, rhs.elements, _CMP_GT_OQ) }; // Result as float mask
    ...
    fn ge_elements(&self, rhs: Self) -> Self {
        ...
        // Compare a>=b elementwise
        let elements = unsafe { _mm256_cmp_pd(self.elements, rhs.elements, _CMP_GE_OQ) }; // Result as float mask
...
impl Add for F64x4 {
    ...
    fn add(self, rhs: Self) -> Self::Output {
        ...
        unsafe {
            F64x4 {
                size: self.size,
                elements: _mm256_add_pd(self.elements, rhs.elements),
            }
        }
    }
}
...
impl Sub for F64x4 {
    ...
    fn sub(self, rhs: Self) -> Self::Output {
        ...
        unsafe {
            F64x4 {
                size: self.size,
                elements: _mm256_sub_pd(self.elements, rhs.elements),
            }
        }
    }
}
...
impl Div for F64x4 {
    ...
    fn div(self, rhs: Self) -> Self::Output {
        ...
        unsafe {
            F64x4 {
                size: self.size,
                elements: _mm256_div_pd(self.elements, rhs.elements),
            }
        }
    }
}
...
impl Rem for F64x4 {
    ...
    fn rem(self, rhs: Self) -> Self::Output {
        ...
        unsafe {
            ...
            let prod = _mm256_mul_pd(floor, rhs.elements);

            let elements = _mm256_sub_pd(self.elements, prod);
...
impl PartialEq for F64x4 {
    fn eq(&self, other: &Self) -> bool {
        ...
        unsafe {
            ...
            let cmp = _mm256_cmp_pd(self.elements, other.elements, _CMP_EQ_OQ);
...
impl PartialOrd for F64x4 {
    fn partial_cmp(&self, other: &Self) -> Option<std::cmp::Ordering> {
        ...
        unsafe {
            ...
            let lt_mask = _mm256_movemask_pd(lt);
            let gt_mask = _mm256_movemask_pd(gt);
            let eq_mask = _mm256_movemask_pd(eq);
...
mod f64x4_tests {
    ...
    #[test]
    /// __m256d fields are private and cannot be compared directly
    ...
    /// Splat method should duplicate one value for all elements of __m256d
    #[test]
    fn test_splat() {
        let a = vec![1.0; 4];
    ...
    #[test]
    fn test_div_assign() {
        let mut a = F64x4::new(&[1.0, 2.0]);
        let b = F64x4::new(&[4.0, 3.0]);
