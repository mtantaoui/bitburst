...
impl SimdVec<i64> for I64x8 {
    ...
    fn splat(value: i64) -> Self {
        Self {
            elements: unsafe { _mm512_set1_epi64(value) },
            size: LANE_COUNT,
        }
    }
    ...
    unsafe fn load_partial(ptr: *const i64, size: usize) -> Self {
        ...
        Self {
            elements: unsafe { _mm512_maskz_loadu_epi64(mask, ptr) },
            size,
        }
    }
    ...
    unsafe fn store_at_partial(&self, ptr: *mut i64) {
        ...
        _mm512_mask_storeu_epi64(ptr, mask, self.elements);
    }
...
mod i64x8_tests {
    ...
    fn test_add() {
        ...
        let v2 = I64x8::new(&[1, 10]);
        let u2 = I64x8::new(&[5, 11]);
    ...
    #[test]
    fn test_add_assign() {
        let mut a = I64x8::new(&[1, 2, 3, 4]);
        let b = I64x8::new(&[4, 3, 2, 1]);
